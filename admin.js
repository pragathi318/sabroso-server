...
function orderRow(o) {
    ...
    <td><strong>₹${(o.total || 0).toFixed(0)}</strong></td>
        ...
        <div class="dm-card">
          ...
          <div class="dm-card-body">
            ...
            <div class="dm-card-footer">
              <div class="dm-price">₹${(d.price || 0).toFixed(0)}</div>
...
function renderUsers(filter = 'all') {
    ...
    tbody.innerHTML = (filtered || []).map(u => {
      ...
      <td>${ordersCount}</td>
      <td><strong>₹${spentAmount.toFixed(0)}</strong></td>
      <td>${joinedDate}</td>
...
function renderTopDishes() {
    ...
    tbody.innerHTML = sorted.slice(0, 8).map((d, i) => {
      ...
      <td><strong>₹${revenue.toFixed(0)}</strong></td>
