...
function updateTotal() {
    ...
    document.getElementById('totalPrice').textContent = `₹${currentDish.price * currentQty}`;
}
...
function addToCart() {
    ...
    setTimeout(() => {
        ...
        btn.innerHTML = `<i class="fas fa-cart-plus"></i> Add to Cart — <span id="totalPrice">₹${currentDish.price * currentQty}</span>`;
    }, 2500);
}
