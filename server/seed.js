...
const seedDishes = [
    { name: 'Spaghetti Bolognese', description: 'Classic Italian pasta with rich meat sauce, parmesan, and fresh basil.', price: 949, cuisine: 'European', country: '🇮🇹 Italy', emoji: '🍝', image: 'https://images.unsplash.com/photo-1622973536968-3ead9e780960?w=500', prepTime: 22, spiceLevel: 'Mild', rating: 4.9, totalOrders: 342, isFeatured: true, tags: ['pasta', 'italian', 'classic'] },
    { name: 'Sushi Platter', description: 'Assorted nigiri and maki rolls with wasabi, pickled ginger, and soy sauce.', price: 1399, cuisine: 'Japanese', country: '🇯🇵 Japan', emoji: '🍣', image: 'https://images.unsplash.com/photo-1553621042-f6e147245754?w=500', prepTime: 30, spiceLevel: 'Mild', rating: 4.8, totalOrders: 289, isFeatured: true, tags: ['sushi', 'japanese', 'seafood'] },
    { name: 'Bibimbap Bowl', description: 'Korean rice bowl with seasoned vegetables, egg, and spicy gochujang sauce.', price: 1099, cuisine: 'Korean', country: '🇰🇷 Korea', emoji: '🍚', image: 'https://images.unsplash.com/photo-1590301157890-4810ed352733?w=800', prepTime: 18, spiceLevel: 'Medium', rating: 4.7, totalOrders: 245, isFeatured: true, tags: ['korean', 'rice', 'healthy'] },
    { name: 'Chicken Tacos', description: 'Grilled chicken tacos with fresh salsa, guacamole, and lime crema.', price: 799, cuisine: 'Mexican', country: '🇲🇽 Mexico', emoji: '🌮', image: 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=500', prepTime: 15, spiceLevel: 'Hot', rating: 4.8, totalOrders: 312, isFeatured: true, tags: ['tacos', 'mexican', 'spicy'] },
    { name: 'Moambe Chicken', description: 'Traditional African chicken stewed in rich palm nut sauce with vegetables.', price: 1249, cuisine: 'African', country: '🌍 Africa', emoji: '🍗', image: 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=500', prepTime: 28, spiceLevel: 'Medium', rating: 4.6, totalOrders: 178, tags: ['african', 'chicken', 'stew'] },
    { name: 'Tonkotsu Ramen', description: 'Rich pork bone broth ramen with chashu, soft egg, and bamboo shoots.', price: 1049, cuisine: 'Japanese', country: '🇯🇵 Japan', emoji: '🍜', image: 'https://images.unsplash.com/photo-1591814468924-caf88d1232e1?w=500', prepTime: 25, spiceLevel: 'Medium', rating: 4.9, totalOrders: 267, isFeatured: true, tags: ['ramen', 'japanese', 'noodles'] },
    { name: 'Mushroom Risotto', description: 'Creamy Arborio rice with wild mushrooms, truffle oil, and parmesan.', price: 1299, cuisine: 'European', country: '🇮🇹 Italy', emoji: '🍄', image: 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=500', prepTime: 30, spiceLevel: 'Mild', rating: 4.7, totalOrders: 198, tags: ['risotto', 'italian', 'vegetarian'] },
    { name: 'Kimchi Jjigae', description: 'Spicy Korean kimchi stew with tofu, pork, and vegetables.', price: 999, cuisine: 'Korean', country: '🇰🇷 Korea', emoji: '🥘', image: 'https://images.unsplash.com/photo-1580651315530-69c8e0026377?w=500', prepTime: 20, spiceLevel: 'Hot', rating: 4.5, totalOrders: 156, tags: ['korean', 'spicy', 'stew'] },
    { name: 'Churros & Chocolate', description: 'Crispy cinnamon churros with warm Mexican chocolate dipping sauce.', price: 649, cuisine: 'Mexican', country: '🇲🇽 Mexico', emoji: '🍫', image: 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=500', prepTime: 12, spiceLevel: 'Mild', rating: 4.8, totalOrders: 203, tags: ['dessert', 'mexican', 'sweet'] },
    { name: 'Jollof Rice', description: 'West African tomato rice with aromatic spices and grilled chicken.', price: 899, cuisine: 'African', country: '🌍 Africa', emoji: '🍚', image: 'https://images.unsplash.com/photo-1604329760661-e71dc83f8f26?w=500', prepTime: 25, spiceLevel: 'Medium', rating: 4.6, totalOrders: 134, tags: ['african', 'rice', 'chicken'] },
    { name: 'Margherita Pizza', description: 'Classic Neapolitan pizza with San Marzano tomatoes, mozzarella, and basil.', price: 999, cuisine: 'European', country: '🇮🇹 Italy', emoji: '🍕', image: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500', prepTime: 18, spiceLevel: 'Mild', rating: 4.9, totalOrders: 321, isFeatured: true, tags: ['pizza', 'italian', 'classic'] },
    { name: 'Tempura Udon', description: 'Thick wheat noodles in dashi broth with crispy shrimp and vegetable tempura.', price: 1099, cuisine: 'Japanese', country: '🇯🇵 Japan', emoji: '🍤', image: 'https://images.unsplash.com/photo-1617093727343-374698b1b08d?w=500', prepTime: 20, spiceLevel: 'Mild', rating: 4.7, totalOrders: 189, tags: ['udon', 'japanese', 'noodles'] }
];
